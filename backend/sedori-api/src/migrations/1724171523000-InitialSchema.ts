...
export class InitialSchema1724171523000 implements MigrationInterface {
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `ALTER TABLE "recommendations" DROP CONSTRAINT "FK_96a7e26b5c2cd4da5ca7b5ff9a6"`,
    );
    await queryRunner.query(
      `ALTER TABLE "recommendations" DROP CONSTRAINT "FK_bb04d8ac6142537c8c1ce9bb4a3"`,
    );
    await queryRunner.query(
      `ALTER TABLE "sales" DROP CONSTRAINT "FK_06dd18bbf0f6c6ad063cf9dcd4b"`,
    );
    await queryRunner.query(
      `ALTER TABLE "sales" DROP CONSTRAINT "FK_5bb50b65e3a6d5a2c6cf3e60b6a"`,
    );
    await queryRunner.query(
      `ALTER TABLE "products" DROP CONSTRAINT "FK_ff0c0301a95e517153df97f6812"`,
    );
    await queryRunner.query(
      `ALTER TABLE "categories" DROP CONSTRAINT "FK_9a6f051e12274fae0e5c2d5a59d"`,
    );

    // Drop indexes
    await queryRunner.query(
      `DROP INDEX "public"."idx_recommendations_created"`,
    );
    ...
    await queryRunner.query(
      `DROP INDEX "public"."idx_recommendations_product"`,
    );
